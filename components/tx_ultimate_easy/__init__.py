...
from .rtttl_synth_gen import (
    CONF_RTTTL_SYNTH,
    CONF_INSTRUMENTS,
    CONF_ENVELOPES,
    CONF_TUNES,
    CONF_SAMPLE_RATE,
    build_rtttl_synth_schema,
    generate_rtttl_synth_code,
)
...
RTTTL_SYNTH_SCHEMA = build_rtttl_synth_schema(cv)
...
async def to_code(config):
    ...
    if generate_rtttl_synth_code(instruments, envelopes, tunes, sample_rate):
